...
public class FPGrowth {
     ...
     * @throws IOException 
     */
    public static void tt()/*static void main(String[] args)*/ throws IOException {
    	long time1 = System.currentTimeMillis();
        System.out.println("Star time: "+time1);
        System.out.println("FP growth Algorithm");
    	
        FPGrowth fpg = new FPGrowth();
        fpg.setMinSup(2);
        //List<String> data = fpg.buildData("retail.dat");
        List<String> data = fpg.buildData(" ");
...
/*
    ...
    //  fpg.printCondFPTree(condFPTree);
        ...
        //输出到文件fp.txt
        //将时间输出到指定文件
        FileWriter fWriter = new FileWriter("/Users/durant/Documents/fp.txt",true);
...
//        }else{
           ...
           //data.add("productpage");
           // data.add("details productpage ratings reviews");
//            data.add("details productpage ratings reviews");
//            data.add("details productpage ratings reviews");
//            data.add("productpage");
//            data.add("details productpage ratings reviews");
